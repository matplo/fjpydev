...
# if(NOT TARGET CMakeSwig::fastjet)
# 	message(FATAL_ERROR "Python: missing fastjet TARGET")
# endif()
...
set(Python_ADDITIONAL_VERSIONS "3.7;3.6;3.5;3.4;2.7" CACHE STRING "Python to use for binding")
...
add_subdirectory(mptools/python)
...
configure_file(cmake/__init__.py.in python/${PROJECT_NAME}/mptools/__init__.py COPYONLY)
...
#	COMMAND ${CMAKE_COMMAND} -E echo "  '${PROJECT_NAME}.fastjet':['$<TARGET_FILE_NAME:pyfastjet>']," >> setup.py
	...
	COMMAND ${CMAKE_COMMAND} -E echo "  '${PROJECT_NAME}.mptools':['$<TARGET_FILE_NAME:pymptools>']," >> setup.py
	COMMAND ${CMAKE_COMMAND} -E echo "  }," >> setup.py
...
#	COMMAND ${CMAKE_COMMAND} -E copy $<TARGET_FILE:pyfastjet> ${PROJECT_NAME}/fastjet
#	COMMAND ${CMAKE_COMMAND} -E copy $<TARGET_FILE:fastjet> ${PROJECT_NAME}/.libs
	...
	COMMAND ${CMAKE_COMMAND} -E copy $<TARGET_FILE:pymptools> ${PROJECT_NAME}/mptools
	COMMAND ${CMAKE_COMMAND} -E copy $<TARGET_FILE:mptools> ${PROJECT_NAME}/.libs
